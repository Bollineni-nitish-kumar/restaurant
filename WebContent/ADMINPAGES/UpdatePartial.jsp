...
<tr style="height:30%">
<td style="font-size:30px;text-align:center"><h4>The duplicate table numbers is present. please enter unique table number.Remaining  saved successfully.</h4></td></tr>
</table>
</div>
</body>
</html>